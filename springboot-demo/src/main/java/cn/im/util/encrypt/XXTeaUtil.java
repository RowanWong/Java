...
public class XXTeaUtil {
	 ...
	 * @throws Exception
	 */
	public static String encrypt(String plain, String charset, String hexKey) throws UnsupportedEncodingException {
	...
	public static void main(String args[]) {
		...
		try {
			...
			String cipherText = XXTeaUtil.encrypt(plainText, "UTF-8", ByteFormat.toHex(key));
			System.out.println(cipherText);

			String pText = XXTeaUtil.decrypt(cipherText, "UTF-8", ByteFormat.toHex(key));
