...
public class SysUtil {
     ...
     * JVM的版本
     */
    public static final String JVM_VERSION = PropertyUtils.key("java.version");
    /**
     * JVM的编码
     */
    public static final String JVM_ENCODING = PropertyUtils.key("file.encoding");
    /**
     * JVM默认的临时目录
     */
    public static final String JVM_TEMPDIR = PropertyUtils.key("java.io.tmpdir");
     ...
     * 主机架构
     */
    public static String OS_ARCH = PropertyUtils.key("os.arch");
    /**
     * 主机类型
     */
    public static String OS_NAME = PropertyUtils.key("os.name");
    /**
     * 主机类型版本
     */
    public static String OS_VERSION = PropertyUtils.key("os.version");
    /**
     * 操作系统类型
     */
    public static String SUN_DESKTOP = PropertyUtils.key("sun.desktop");
    /**
     * 当前用户
     */
    public static String CURRENT_USER = PropertyUtils.key("user.name");
    /**
     * 当前用户的家目录
     */
    public static String CURRENT_USER_HOME = PropertyUtils.key("user.home");
    /**
     * 当用用户的工作目录
     */
    public static String CURRENT_USER_DIR = PropertyUtils.key("user.dir");
    public static String FILE_SEPARATOR = PropertyUtils.key("file.separator");
    public static String PATH_SEPARATOR = PropertyUtils.key("path.separator");
    public static String LINE_SEPARATOR = PropertyUtils.key("line.separator");
    /**
     * 总的物理内存
     */
